...
# 107 "gcdata.c"
volatile unsigned char gLowThreshold = 0x32;





volatile unsigned char gCommandOriginMask = 0xBE;
volatile unsigned char gCommandPollMask = 0xBF;

void desyncfix(void) {
    _delay((unsigned long)((450)*(64000000/4000000.0)));
    __asm("BSF _gInStatus, 5, 0");
}
