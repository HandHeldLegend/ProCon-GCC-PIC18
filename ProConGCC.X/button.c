...
void checkbuttons(void)
{
    ...
    // INVERSE of incoming button bits and shift to the left.
    ...
    gConPollPacket[BUTTON_PORT_A] |= !START_IN_PORT << 1;
    ...
    gConPollPacket[BUTTON_PORT_B] = 1 << 1;
    gConPollPacket[BUTTON_PORT_B] |= !ZL_IN_PORT << 1;
    gConPollPacket[BUTTON_PORT_B] |= !ZR_IN_PORT << 1;
    
    // Don't shift for the first check for the Z button (L/R mapped to Z button)
    gConPollPacket[BUTTON_PORT_B] |= !L_IN_PORT;
    gConPollPacket[BUTTON_PORT_B] |= !R_IN_PORT << 1;
    
    gConPollPacket[BUTTON_PORT_B] |= !DU_IN_PORT << 1;
    gConPollPacket[BUTTON_PORT_B] |= !DD_IN_PORT << 1;
